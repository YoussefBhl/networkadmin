function otherCtrl($scope, devicesFactory, $location, $state, $uibModal, $http) {
    ...
    devicesFactory.getOther({type:'camera'}).success(handleSuccess);
...
otherCtrl.prototype = Object.create(listeBaseCtrl.prototype);
angular
    .module('inspinia')
