function routerCtrl($scope, devicesFactory, $location, $state, $uibModal, $http) {
    ...
    devicesFactory.getRouter({type:'camera'}).success(handleSuccess);
...
routerCtrl.prototype = Object.create(listeBaseCtrl.prototype);
angular
    .module('inspinia')
