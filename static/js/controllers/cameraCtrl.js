function cameraCtrl($scope, devicesFactory, $location, $state, $uibModal, $http) {
    ...
    devicesFactory.getCamera({type:'camera'}).success(handleSuccess);
...
cameraCtrl.prototype = Object.create(listeBaseCtrl.prototype);
angular
    .module('inspinia')
